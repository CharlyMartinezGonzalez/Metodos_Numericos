...
public class MetodoJacobi {
    ...
    public static void jacobi(double[][] A, double[] b, double[] x, double tolerance, int maxIterations) {
        DecimalFormat df = new DecimalFormat("0.00"); // Formato para 2 decimales
        int n = b.length;
    ...
    public static void main(String[] args) {
        ...
        // Mostrar la solución con 2 decimales
        DecimalFormat df = new DecimalFormat("0.00");
        System.out.println("Solución:");
        System.out.println("x = " + df.format(x[0]));
        System.out.println("y = " + df.format(x[1]));
        System.out.println("z = " + df.format(x[2]));
    }
}
